...
function Offers() {
  ...
  return (
    <>
      <div className=''>
        <h1 className='md:text-3xl text-xl font-bold text-zinc-900 text-center'>اكتشف العروض المتاحة</h1>
        ...
        <div className="flex justify-center w-full">
          <a href='#' className='flex items-center justify-center text-sm w-full md:w-fit self-start bg-orange-400 text-white font-semibold p-2 px-4 rounded-md border border-orange-600 transition-all duration-200 ease-in-out'>
            <div>قم بتقديم عرضك</div>
